...
To use, add players by checking their name, or remove them by unchecking. 
Then add monsters by clicking. Clicking the same monster again adds another monster to the list. Remove monsters by clicking on their name in the queue.
After all characters are added, click "Roll for initiaitve", the Initiative list will show who goes first from top to down, as well as the number they rolled.
"""
